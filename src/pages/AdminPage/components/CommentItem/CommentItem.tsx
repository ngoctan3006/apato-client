...
import {blockUserHandlerAPI, deleteCommentAPI, getReportDetail} from "../../../../api/service";
            ...
            <div className={styles.itemCollapse}>
                <div className={styles.itemContent}>
                    ...
                    <div className={`${styles.alignRow} ${styles.marginView}`}>
                        <AppText
                            className={styles.itemRate}>Ngày
                            report: {new Date(createdAt).toLocaleDateString()}</AppText>
                    </div>
                </div>
            ...
            </div>
            {
                showDetail && <div style={{
                    ...
                    <div style={{
                        ...
                        <AppText
                            className={styles.commentDate}>{new Date(detailComment?.comment?.created_at).toLocaleDateString()}</AppText>
                    </div>
